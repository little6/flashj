...
import com.flashj.common.util.PhoneUtil;
import com.flashj.merchant.service.convert.MerchantConvert;
import com.flashj.merchant.service.convert.StaffConvert;
import com.flashj.merchant.service.convert.StoreConvert;
...
import com.flashj.merchant.service.entity.StoreStaff;
import com.flashj.merchant.service.feign.TenantServiceFeign;
import com.flashj.merchant.service.mapper.MerchantMapper;
import com.flashj.merchant.service.mapper.StaffMapper;
import com.flashj.merchant.service.mapper.StoreMapper;
import com.flashj.merchant.service.mapper.StoreStaffMapper;
...
public class MerchantServiceImpl implements MerchantService {
    ...
    @Autowired
    TenantServiceFeign tenantService;
...
//        merchantDTO.setMerchantName(merchant.getMerchantName());
    ...
    public MerchantDTO createMerchant(MerchantDTO merchantDTO) throws BusinessException {
        ...
        TenantDTO tenantAndAccount = tenantService.createTenantAndInit(createTenantRequestDTO);
        //获取租户的id
...
//        merchant.setMobile(merchantDTO.getMobile());
        //..写入其它属性
        //使用MapStruct进行对象转换
        Merchant merchant = MerchantConvert.dto2entity(merchantDTO);
        //设置所对应的租户的Id
...
//        merchantDTO.setId(merchant.getId());
    ...
    public void applyMerchant(Long merchantId, MerchantDTO merchantDTO) throws BusinessException {
        ...
        //将dto转成entity
        Merchant entity = MerchantConvert.dto2entity(merchantDTO);
        //将必要的参数设置到entity
    ...
    public StoreDTO createStore(StoreDTO storeDTO) throws BusinessException {
        Store entity = StoreConvert.dto2entity(storeDTO);
        log.info("新增门店：{}", JSON.toJSONString(entity));
        //新增门店
        storeMapper.insert(entity);

        return StoreConvert.entity2dto(entity);
    }
    ...
    public StaffDTO createStaff(StaffDTO staffDTO) throws BusinessException {
        ...
        Staff staff = StaffConvert.dto2entity(staffDTO);
        staffMapper.insert(staff);

        return StaffConvert.entity2dto(staff);
    }
    ...
    public PageVO<StoreDTO> queryStoreByPage(StoreDTO storeDTO, Integer pageNo, Integer pageSize) {
        ...
        List<StoreDTO> storeDTOS = StoreConvert.listentity2dto(records);
