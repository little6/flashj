package com.flashj.user.controller;
...
public class TenantController {
    ...
    public PageVO<TenantDTO> queryTenants(@RequestBody TenantQueryDTO tenantQuery, @RequestParam Integer pageNo,
    ...
    public PageVO<AccountDTO> queryAccount(@RequestBody AccountQueryDTO accountQuery, @RequestParam Integer pageNo, Integer pageSize,
                                           @RequestParam String sortBy, @RequestParam String order) {
